...
/*
# OAC Video Annotation Tool v0.131210
# 
...
#  
# Date: Thu Mar 7 10:08:45 2013 -0500
#  
  ...
  (function($, MITHgrid, OAC) {
              ...
              captureMouse = function(handlers) {
                if (!mouseCaptured) {
                  ...
                  return MITHgrid.mouse.capture(function(eType) {
                    if (handlers[eType] != null) {
                      return handlers[eType](this);
                    }
                  });
                }
              };
    ...
    OAC.Client.StreamingVideo.namespace("Player", function(exports) {
      ...
      $(document).ready(function() {
        var cb, _i, _len;
        exports.register = function(driverName, driverObjectCB) {
          var bp, driverObject, player, _i, _j, _len, _len1, _ref, _ref1, _results;
          driverObject = {};
          ...
          _ref1 = driverObject.getAvailablePlayers();
          _results = [];
      ...
      exports.addPlayer = function(driverName, player) {
        ...
        if (drivers[driverName] != null) {
          ...
          if ((_ref = pendingPlayers[driverName]) == null) {
          ...
          return (_ref = MITHgrid.Presentation).initInstance.apply(_ref, ["OAC.StreamingVideo.Client.Presentation.RaphaelCanvas"].concat(__slice.call(args), [function(that, container) {
            ...
            updateLocation = function() {
              ...
              if (playerObj != null) {
                ...
                _ref1 = playerObj.getSize(), w = _ref1[0], h = _ref1[1];
                screenSize = {
                  width: w,
                  height: h
                };
    ...
    return OAC.Client.StreamingVideo.namespace("Application", function(Application) {
      ...
      return Application.initInstance = function() {
        ...
        return appOb = (_ref = MITHgrid.Application).initInstance.apply(_ref, ["OAC.Client.StreamingVideo.Application"].concat(__slice.call(args), [{
          ...
          var NS, options, parseNPT, playerObj, screenSize, shapeAnnotationId, shapeTypes, wh, xy, _ref, _ref1;
          shapeTypes = {};
          screenSize = {};
          shapeAnnotationId = 0;
          xy = [];
          ...
          if (playerObj != null) {
            _ref1 = playerObj.getSize(), screenSize.width = _ref1[0], screenSize.height = _ref1[1];
          ...
          app.importData = function(data) {
            var bits, doc, dom, fragment, hasSelector, hasSubSelector, hasTarget, i, info, o, rootName, s, shapeInfo, svg, t, temp, tempstore, types, v, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
            tempstore = [];
            for (i in data) {
              o = data[i];
                    ...
                    if ((data[hasTarget] != null) && (data[hasTarget]["" + NS.OA + "hasSource"] != null)) {
                      if ((_ref4 = options.url, __indexOf.call((function() {
                        ...
                        for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
                          ...
                          if ((data[hasSelector] != null) && (_ref6 = "" + NS.OA + "Composite", __indexOf.call((function() {
                            ...
                            _ref7 = (function() {
                              ...
                              _ref7 = data[hasSelector]["" + NS.OA + "item"];
                              _results = [];
                            ...
                            for (_k = 0, _len2 = _ref7.length; _k < _len2; _k++) {
                              ...
                              if (data[hasSubSelector] != null) {
                                ...
                                if (_ref8 = "" + NS.OA + "SvgSelector", __indexOf.call(types, _ref8) >= 0) {
          ...
          app.exportData = function() {
            ...
            genTarget = function(obj, ids) {
              ...
              return uri(ids.fgid, NS.DCTERMS, "conformsTo", "http://www.w3.org/TR/media-frags/");
            };
            createJSONObjSeries = function(ids) {
              var obj, _ref2, _ref3, _ref4, _ref5, _ref6;
              obj = app.dataStore.canvas.getItem(ids.id);
              if ((_ref2 = ids.buid) == null) {
                ids.buid = '_:b' + uuid();
              }
              if ((_ref3 = ids.tuid) == null) {
                ids.tuid = '_:t' + uuid();
              }
              if ((_ref4 = ids.suid) == null) {
                ids.suid = '_:sel' + uuid();
              }
              if ((_ref5 = ids.svgid) == null) {
                ids.svgid = '_:sel' + uuid();
              }
              if ((_ref6 = ids.fgid) == null) {
                ids.fgid = '_:sel' + uuid();
              }
