 ...
 * 
 */
var MITHGrid=MITHGrid||{},jQuery=jQuery||{},Raphael=Raphael||{};(function(a,b){b.Presentation.namespace("RaphSVG"),b.Presentation.RaphSVG.initPresentation=function(c,d){var e=b.Presentation.initPresentation("RaphSVG",c,d),f=a(c).attr("id"),g,h;d.cWidth!==undefined?h=d.cWidth:h=a(c).width(),d.cHeight!==undefined?g=d.cHeight:g=a(c).height(),e.canvas=new Raphael(f,h,g);return e}})(jQuery,MITHGrid);