...
#
OAC.Client.StreamingVideo.initApp = (container, options) ->
	shapeTypes = {}
	shapeAnnotationId = 0
	...
	app = MITHGrid.Application.initApp "OAC.Client.StreamingVideo", container, extendedOpts
	...
	app.exportData = (data) ->
		...
		genTarget = (obj, id) ->
			...
			bnode id[0], NS.OA,  "hasSelector", suid
	...
	app.ready ->
		...
		#
		lensRectangle = (container, view, model, itemId) ->
		...
		# The rendering object.
		#
		lensEllipse = (container, view, model, itemId) ->
			that = app.initShapeLens container, view, model, itemId
			item = model.getItem itemId
