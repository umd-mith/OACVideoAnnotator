		...
		**/
		...
		loadUri = function(uri, cb) {
	      ...
	      getRect = function(tgt) {
	        var doc, pth, rect, th, tw, tx, ty, _ref3;
	        if (tgt.constraint != null) {
	          ...
	          _ref3 = tgt.fragmentInfo; tx = _ref3[0]; ty = _ref3[1]; tw = _ref3[2]; th = _ref3[3];
	        } else {
	          return null;
	        }
	        return [tx, ty, tw, th];
	      ...
	      importManifestToDataStore = function(data, cb) {
	        var finishImport, hasValue, i, info, k, kk, r, sync, uris, v, _i, _j, _len, _len2;
	        console.log(data);
	        uris = [];
	        ...
	        return finishImport = function() {
	          var b_ps, bits, body, canvas, dump, items, ps, s, src, src_ps, target, type;
	      ...
	      that.loadManifest = function(remoteUri, manifestUri, cb) {
	        ...
	        return loadUri(remoteUri, function() {
	      ...
	      processManifest = function(uri, cb) {
	        var annoProcessor, audioAnnos, commentAnnos, imgAnnos, rangeAnnos, ranges, seqs, textAnnos, uri2, zoneAnnos;
	        console.log("Processing manifest for ", uri);
	        seqs = [];
	        textAnnos = {
	          '*': []
	        };
	        ...
	        if (seqs.length === 1) {
	          ...
	          return loadUri(uri2, function() {
	            return processSequence(uri2, function() {
