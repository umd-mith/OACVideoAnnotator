...
MITHGrid.Presentation.namespace "AnnotationList", (AnnotationList) ->
	AnnotationList.initPresentation = (container, options) ->
		that = MITHGrid.Presentation.initPresentation "MITHGrid.Presentation.AnnotationList", container, options
...
MITHGrid.Presentation.namespace "RaphaelCanvas", (RaphaelCanvas) ->
	RaphaelCanvas.initPresentation = (container, options) ->
		that = MITHGrid.Presentation.initPresentation "MITHGrid.Presentation.RaphaelCanvas", container, options
