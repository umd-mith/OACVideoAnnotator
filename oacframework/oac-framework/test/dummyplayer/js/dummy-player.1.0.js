...
function DummyPlayer(domObject, index) {
	...
	this.setAspect= function(){
		$(this.DOMObject).css('background','url("dummyplayer/images/dummy.png") no-repeat scroll right bottom #F8C700');
	...
	this.setContent= function(){
		...
		$(this.DOMObject).append('<ul id="player-content-'+this.index+'" style="list-style-type: none;padding:0;">' 
				...
				+ '			<li style="margin:0 8px; display: inline;"><a onClick="'+player+'.rewind(5)"><img src="dummyplayer/images/rewind.png"></a></li>'
				+ '			<li style="margin:0 8px; display: inline;"><a onClick="'+player+'.toggle()"><img src="dummyplayer/images/playpause.png"></a></li>'
				+ '			<li style="margin:0 8px; display: inline;"><a onClick="'+player+'.forward(5)"><img src="dummyplayer/images/forward.png"></a></li>'
				+ '		</ul>'
				+ '</li>'
				+ '</ul>');
	}
